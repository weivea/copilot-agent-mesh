...
export const MESH_ERROR_CODES = {
	...
	COLLABORATION_NOT_FOUND: 1025,
	COLLABORATION_ID_CONFLICT: 1026,
	COLLABORATION_NOT_CANCELLABLE: 1027,
	COLLABORATION_DAG_INVALID: 1028,
	ARTIFACT_NOT_FOUND: 1029,
	ARTIFACT_FORBIDDEN: 1030,
	ARTIFACT_INVALID: 1031,
	ARTIFACT_CORRUPT: 1032,
	ARTIFACT_LIMIT_EXCEEDED: 1033,
	FEATURE_DISABLED: 1034,
	VALIDATION_FAILED: 1035,
} as const;
