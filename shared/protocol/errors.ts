...
export const MESH_ERROR_CODES = {
	...
	PEER_NOT_ALLOWED: 1025,
	PEER_NOT_ACCEPTING: 1026,
	PEER_OFFLINE: 1027,
	PEER_MULTI_WORKSPACE: 1028,
	ARTIFACT_NOT_FOUND: 1029,
	ARTIFACT_FORBIDDEN: 1030,
	ARTIFACT_INVALID: 1031,
	ARTIFACT_CORRUPT: 1032,
	ARTIFACT_LIMIT_EXCEEDED: 1033,
	WINDOW_NAME_CONFLICT: 1034,
	POLICY_FORBIDDEN: 1035,
	DELEGATION_RECURSION: 1036,
	WINDOW_NAME_INVALID: 1037,
	IDEMPOTENCY_CONFLICT: 1038,
} as const;
