...
> Status: 0.2.0 Preview implemented; Gate G0 Go for validated macOS arm64 scope<br>
...
| AHP package | TypeScript package `0.9.0` from pinned upstream commit `fa92d47d3f3ac6732af2019b52826d2d638a4219`; negotiates AHP `1.0.0` | Current VS Code 1.135.0 Agent Host handshake and real turn passed | Pass; upstream revision is not yet tagged or npm-published |
